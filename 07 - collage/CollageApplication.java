    ...
    public void start(Stage stage) {
        ...
        while (yCoordinate < height / 2) {
            ...
            while (xCoordinate < width / 2) {
                ...
                imageWriter.setColor((width / 2) + xCoordinate, yCoordinate, newColor);
                imageWriter.setColor(xCoordinate, (height / 2) + yCoordinate, newColor);
                imageWriter.setColor((width / 2) + xCoordinate, (height / 2) + yCoordinate, newColor);
